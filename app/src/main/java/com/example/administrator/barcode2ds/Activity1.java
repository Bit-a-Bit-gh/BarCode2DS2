    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT > 21) {
          ...
          //读写内存权限
            ...
            if (ActivityCompat.checkSelfPermission(Activity1.this,  Manifest.permission.WRITE_EXTERNAL_STORAGE)!=PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Activity1.this, new String[]{
